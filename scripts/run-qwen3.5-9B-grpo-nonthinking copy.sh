...
# Qwen3.5-9B GRPO, single node / 8 x 96G GPU, colocated train + rollout.
#
# Batch mapping:
...
SAVE_DIR=${SAVE_DIR:-/mnt/cpfs/users/zhy/opd/GRPO/checkpoints/Qwen3.5-9B-GRPO-nonthinking}
...
# dataset.
TRAIN_DATASET=${TRAIN_DATASET:-polaris}
...
WANDB_ARGS=(
  ...
  --wandb-group polaris-math-20k-nonthinking
  --wandb-dir "${WANDB_DIR}"
  --log-passrate
)
